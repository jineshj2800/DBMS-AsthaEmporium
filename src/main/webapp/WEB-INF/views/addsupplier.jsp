...
<div class="container" style="margin-top:92px">
	...
	<div class="panel panel-primary" >
		<div class="panel-heading">
			<div class="panel-title text-center" style="font-size: x-large;"> Add Supplier </div>
		</div>
	</div>

	<div class="row">
		<form action="savesupplier" method="post" modelAttribute="supplier">
					<div class="col-sm-12">
						<c:choose>
						...
						<div class="form-group">
                            ...
                            <textarea class="form-control" placeholder="Enter Description Here.." style="color: black;" rows="4" name="desc"></textarea>
                        </div>
						...
						<div class="form-group">
							...
							<input type="text" placeholder="Enter Bank Name Here.." class="form-control"  name="bname">
						</div>
								
						<div class="form-group">
							<label>Account Number</label>
							<input type="number" placeholder="Enter Account No. Here.." class="form-control"  name="account">
						</div>
						<div class="form-group">
							<label>IFSC Code</label>
								<input type="text" placeholder="Enter IFSC Code Here.." class="form-control" name="ifsc">
						</div>
